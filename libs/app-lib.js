...
// Check for Lock File
  if (fs.existsSync(lockfile)) {
    ...
    try {
      ...
      console.log("ERROR: Cannot read Lock File: " + lockfile);
      console.log(e);
    }

    console.log("ERROR: Lock File Exists: " + lockfile + " for PID: " + pid);
    return false
      ...
      try {
          ...
          console.log("ERROR: Cannot write Lock File: " + lockfile);
          console.log(e);
          return false
      }    
  }
...
function release_lock(lockfile) {
  try {
      ...
      logger('INFO : STOPPING : ' + config.PACKAGE.title + ' : v' + config.PACKAGE.version + " : PID = " + process.pid);
      return true
      } catch (e) {
      console.log("ERROR: Cannot remove Lock File: " + lockfile);
      console.log(e);
      return false
  }
}
